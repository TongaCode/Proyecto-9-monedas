const { desordenarValores } = require("./middleware")
...
function balanzaPrimerPesaje(req, res) {
  let sumaLadoA = 0;
  let sumaLadoB = 0;
  let numerosRepetidos = false;

  // Desordeno los valores de las clves.
...
module.exports = { balanzaPrimerPesaje, monedas };